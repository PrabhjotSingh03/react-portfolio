                ...
                <div className="experience__card__main">
                    <div className="experience__card__container">
                        ...
                        <div className="experience__details">
                            ...
                            <p className="experience__position__description">During my tenure at Extech Digital, I had the privilege of contributing to the development team as a front-end developer. My primary responsibilities included crafting website layouts and user interfaces through the proficient use of HTML and CSS. I seamlessly integrated data from diverse back-end services and databases, ensuring seamless functionality and a seamless user experience. My commitment to best development practices resulted in well-designed and highly efficient code. Moreover, I excelled in gathering and refining specifications and requirements, aligning them with technical needs to drive project success. Additionally, I played a vital role in creating and maintaining comprehensive software documentation, facilitating collaboration and knowledge sharing within the team.</p>
                        </div>
                    </div>
                    <div className="experience__card__container">
                        <div className='experience__image__container'>
                        ...
                        <div className="experience__details">
                            ...
                            <p className="experience__position__description"> A vibrant society with a key focus on the Internet of Things (IoT). Its mission was to cultivate a collaborative space where tech enthusiasts, professionals, and students come together to explore, create, and propel the possibilities of IoT and related technologies. Through workshops, projects, and interdisciplinary collaboration, members enhance their skills, develop innovative solutions, and address real-world challenges. With a strong commitment to ethical considerations, industry networking, and community outreach, SWAT was not just a society—it was a dynamic hub for shaping the future of technology.</p>
                        </div>
                    </div>
                </div>
                </div>
